    ...
    return(
      ...
      <div>
        <div>
          ...
          <input onChange={IDhandlerClick} value={enterID}ref={toDoIDinputRef}  type='number' id='id' />
        </div>
        <div>
          <label htmlFor='title'>Title</label>
          <input onChange={titlehandlerClick} value={enterTitle} ref={toDoTitleinputRef} type='text' id='title' />
        </div>
      </div>
